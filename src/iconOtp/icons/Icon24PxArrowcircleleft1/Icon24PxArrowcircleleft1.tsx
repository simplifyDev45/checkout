...
export const Icon24PxArrowcircleleft1 = ({ color = "#2A7CB4", className }: Props): JSX.Element => {
  return (
    <svg
      className={`icon-24-px-arrowcircleleft-1 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
...
Icon24PxArrowcircleleft1.propTypes = {
