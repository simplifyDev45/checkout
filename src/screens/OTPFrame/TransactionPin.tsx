...
export const TransactionPin = ({ proceed }: Props): JSX.Element => {

  return (
    <div className="frame2">
      <div className="div-3">
        <div className="text-wrapper-9">Transaction PIN</div>
        <IconPx />
      </div>
      <p className="an-email-containing">
        <span className="text-wrapper-10">Please enter your 4-digits transaction</span><br/>
   <span className="text-wrapper-10">pin below. </span>
      </p>
      <NewTextInput className="new-text-input-fields" property1="PIN" />
